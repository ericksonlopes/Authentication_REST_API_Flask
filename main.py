...
from resources.users_resource import UserRegister, UserLogin, UserLogout, User
...
api.add_resource(User, '/user/<int:user_id>')  # pesquisar ou deletar usuario
api.add_resource(UserRegister, '/register')   # Registrar
api.add_resource(UserLogin, '/login')         # logar
api.add_resource(UserLogout, '/logout')       # deslogar
